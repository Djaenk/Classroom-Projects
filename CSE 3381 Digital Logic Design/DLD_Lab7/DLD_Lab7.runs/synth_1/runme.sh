...
HD_PWD='U:/DLD_Lab7/DLD_Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encode_top.tcl
