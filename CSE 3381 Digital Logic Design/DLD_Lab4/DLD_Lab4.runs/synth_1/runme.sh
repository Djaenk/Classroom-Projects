...
HD_PWD='U:/DLD_Lab4/DLD_Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_bit_adder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source three_bit_adder_top.tcl
