...
HD_PWD='U:/DLD_Lab4/DLD_Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log three_bit_adder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source three_bit_adder_top.tcl -notrace
