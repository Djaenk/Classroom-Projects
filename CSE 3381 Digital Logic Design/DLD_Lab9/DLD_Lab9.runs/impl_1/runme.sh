...
HD_PWD='U:/DLD_Lab9/DLD_Lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log state_machine_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source state_machine_top.tcl -notrace
