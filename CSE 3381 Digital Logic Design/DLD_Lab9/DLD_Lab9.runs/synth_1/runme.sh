...
HD_PWD='U:/DLD_Lab9/DLD_Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_machine_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state_machine_top.tcl
