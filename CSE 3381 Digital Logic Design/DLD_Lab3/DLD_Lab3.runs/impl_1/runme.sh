...
HD_PWD='U:/DLD_Lab3/DLD_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gates_top.tcl -notrace
