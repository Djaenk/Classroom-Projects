...
HD_PWD='U:/DLD_Lab5/DLD_Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplexer_top.tcl -notrace
