...
HD_PWD='U:/DLD_Lab5/DLD_Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_top.tcl
