...
HD_PWD='U:/DLD_Lab6/DLD_Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encode_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encode_top.tcl -notrace
