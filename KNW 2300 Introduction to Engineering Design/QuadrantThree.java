...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static int moveToLocation(RXTXRobot r, double[] destination, char[] beacon_chars, int[] beacon_angles, int quadrant)
	{
		...
		double angle1 = (((double)beacon_angles[1] - (double)beacon_angles[0]) * 180) / 150;
		double angle2 = (((double)beacon_angles[2] - (double)beacon_angles[1]) * 180) / 150;
		...
		if(beacon_angles[2] == -1){
			...
			r.runTwoPCAMotor(8, 290, 9, -390, 300);
			return 0;
		}
		else{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String[] args) {
		...
		double[] volcano_ramp = new double[]{14.0, 6.0};
		...
		while (success != 1) {
		returnAngles(r);
		success = moveToLocation(r, volcano_base, beacon_chars, beacon_angles, 3);
		}
		success = 0;

		while (success != 1) {
		returnAngles(r);
		success = moveToLocation(r, volcano_ramp, beacon_chars, beacon_angles, 3);
		}
		success = 0;
