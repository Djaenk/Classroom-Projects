...
% the system that uses inches, feet, yards, furlongs, miles, and so on. It also
...
% your code.
%
% This file is called `imperial_hw.pl`. Do not modify it. And do not copy it into
% your file.
%
% Instead, put all the code you write for this assignment` into a file `imperial_soln.pl`.
% Start with just the code you need to solve Part 1, then, after that's working, add
% the code to solve part 2, and so one.
%
...
%
% which asserts that `Factor` is the amount you multiply a
