...
template <typename vertex>
void
SimpleGraph<vertex>::addVertex(const vertex& target){
	if (vertices.find(target) != vertices.end()){
		throw std::invalid_argument("Vertex to be added already exists in SimpleGraph.");
	}
...
template <typename vertex>
void
SimpleGraph<vertex>::removeVertex(const vertex& target){
	if (vertices.find(target) == vertices.end()){
		throw std::out_of_range("Vertex to be removed does not exist in SimpleGraph.");
	}
...
template <typename vertex>
void
SimpleGraph<vertex>::addEdge(const vertex& target1, const vertex& target2){
	if (vertices.find(target1) == vertices.end()
	|| vertices.find(target2) == vertices.end()){
		throw std::out_of_range("Edge to be added requires nonexistent vertex or vertices in SimpleGraph.");
	}
	else if (vertices.at(target1).find(target2) != vertices.at(target1).end()
	|| vertices.at(target2).find(target1) != vertices.at(target2).end()){
		throw std::invalid_argument("Edge to be added already exists in SimpleGraph.");
	}
	else{
...
template <typename vertex>
void
SimpleGraph<vertex>::removeEdge(const vertex& target1, const vertex& target2){
	if (vertices.find(target1) == vertices.end()
	|| vertices.find(target2) == vertices.end()){
		throw std::out_of_range("Edge to by removed requires nonexistent vertex or vertices in SimpleGraph.");
	}
	else if (vertices.at(target1).find(target2) == vertices.at(target1).end()
	|| vertices.at(target2).find(target1) == vertices.at(target2).end()){
		throw std::invalid_argument("Edge to be removed does not exist in SimpleGraph.");
	}
	else{
...
SimpleGraph<vertex>::breadthFirstSearch(const vertex& start, std::unordered_set<vertex>& discovered){
...
template <typename vertex>
std::vector<std::pair<vertex, vertex>>
SimpleGraph<vertex>::breadthFirstSearch(const vertex& start){
...
template <typename vertex>
std::vector<std::pair<vertex, vertex>>
SimpleGraph<vertex>::depthFirstSearch(const vertex& start, std::unordered_set<vertex>& discovered){
	std::vector<std::pair<vertex, vertex>> traversedEdges;
...
template <typename vertex>
std::vector<std::pair<vertex, vertex>>
SimpleGraph<vertex>::depthFirstSearch(const vertex& start){
	std::unordered_set<vertex> discovered;
	discovered.reserve(vertices.size());
...
template <typename vertex>
std::vector<std::pair<vertex, vertex>>
SimpleGraph<vertex>::connect(const vertex& start, const vertex& destination){
...
SimpleGraph<vertex>::defineComponents(
...
template <typename vertex>
void
SimpleGraph<vertex>::updateBetweenness(
...
SimpleGraph<vertex>::highestBetweenness(
	std::unordered_map<std::pair<vertex, vertex>, double, hash_pair>& betweenness
){
...
SimpleGraph<vertex>::discoverCommunities(){
...
template <typename vertex>
void
SimpleGraph<vertex>::readtextFormat(std::string graph){
